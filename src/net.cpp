...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("MasterSwiscoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("MasterSwiscoin-net");
...
static const char *strDNSSeed[][2] = {
    ...
    {"swisexplorer.com", "swisexplorer.com"},
	{"dns.swisexplorer.com", "dns.swisexplorer.com"}
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("MasterSwiscoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("MasterSwiscoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("MasterSwiscoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("MasterSwiscoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. MasterSwiscoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("MasterSwiscoin-start");
