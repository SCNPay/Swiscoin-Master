...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("MSCN");
    case mBTC: return QString("mMSCN");
    case uBTC: return QString::fromUtf8("μMSCN");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Master Swiscoins"));
    case mBTC: return QString(QObject::tr("Milli-MasterSwiscoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-MasterSwiscoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
