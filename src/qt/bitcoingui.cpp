...
{
    resize(850, 550);
    setWindowTitle(tr("Master Swiscoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a MasterSwiscoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About MasterSwiscoin"), this);
    aboutAction->setStatusTip(tr("Show information about MasterSwiscoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MasterSwiscoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MasterSwiscoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MasterSwiscoin addresses"));
    secondAuthAction = new QAction(QIcon(":/icons/key"), tr("Second &auth..."), this);
    secondAuthAction->setStatusTip(tr("Second auth with your MasterSwiscoin addresses"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Master Swiscoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Master Swiscoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MasterSwiscoin network", "", count));
}
...
{
    QString strTitle = tr("Master Swiscoin") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid MasterSwiscoin address or malformed URI parameters."));
    }
